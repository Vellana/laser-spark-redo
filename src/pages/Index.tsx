      ...
      <main>
        ...
        <section className="py-12 bg-secondary/20">
          <div className="container mx-auto px-4 max-w-4xl text-center md:text-left">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Our <Link to="/laser-skin-resurfacing" className="text-accent hover:underline">fractional CO2 laser Tysons</Link> treatments use the Cartessa Tetra Pro for CoolPeel <Link to="/laser-skin-resurfacing" className="text-accent hover:underline">CO2 laser resurfacing Vienna VA</Link> patients trust for radiant, refreshed skin with minimal downtime. For deeper rejuvenation, our fractional <Link to="/laser-skin-resurfacing" className="text-accent hover:underline">DEKA Tetra Pro Vienna</Link> option smooths wrinkles, acne scars, and sun damage. As a leading provider of <Link to="/laser-skin-resurfacing" className="text-accent hover:underline">laser skin resurfacing Northern Virginia</Link> residents rely on, we tailor every treatment to your skin type and goals, minutes from McLean, Falls Church, and Arlington.
            </p>
          </div>
        </section>
        <section className="py-12 bg-background">
        ...
        <section className="py-12 bg-background">
          <div className="container mx-auto px-4 max-w-4xl text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-serif text-primary mb-4">
              CoolPeel Skin Resurfacing in Tysons
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed">
