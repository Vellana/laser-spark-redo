  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        description="Laser hair removal Vienna VA - Laser hair removal Tysons Corner and laser hair removal Vienna VA with the Lutronic Clarity II, safe for all skin types."
