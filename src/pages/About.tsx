    ...
    return (
        <div className="min-h-screen">
            <SEO 
                ...
                description="Medical spa Tysons and medical spa Vienna VA for laser hair removal, CoolPeel CO2 resurfacing, and scar treatments. Licensed laser techs. 703-547-4499."
                canonicalUrl="/about"
            />
            <LocalBusinessSchema />
