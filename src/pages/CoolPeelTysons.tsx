  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        description="CoolPeel skin resurfacing Tysons and CoolPeel Vienna VA with the DEKA Tetra Pro CO2 platform. 1-3 day recovery and free consultations. 703-752-6608."
