      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center max-w-3xl mx-auto w-full">
          ...
          >
            <div style={{ padding: '16px' }}>
              <a 
                href="https://www.instagram.com/virginialaserspecialists/?utm_source=ig_embed&utm_campaign=loading" 
                style={{ 
                  background: '#FFFFFF', 
                  lineHeight: 0, 
                  padding: '0 0', 
              ...
              <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                <a href="https://www.instagram.com/virginialaserspecialists/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">Virginia Laser Specialists</a> (@<a href="https://www.instagram.com/virginialaserspecialists/?utm_source=ig_embed&utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank" rel="noopener noreferrer">virginialaserspecialists</a>) • Instagram photos and videos
              </p>
            </div>
          </blockquote>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-muted-foreground">
            Click to view our full profile on Instagram
          </p>
        </div>
      </div>
    </section>
