...
const services: ServiceArea[] = [
  ...
  },
  {
    ...
    fullDescription: "Includes: Upper lip, chin, cheeks, sideburns, forehead and hairline. Our full face laser hair removal addresses unwanted hair on the entire face, excluding the eye area.",
    singlePrice: "$250",
  ...
  },
  {
    ...
    fullDescription: "Includes: Upper torso (does not include shoulders or abdomen). Achieve a smooth, hair-free chest with our professional laser treatment.",
    singlePrice: "$250",
    packagePrice: "$937.50 (save 25%)",
  },
  {
